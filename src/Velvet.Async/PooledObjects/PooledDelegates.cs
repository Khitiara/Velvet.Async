...
public delegate void StatelessReadOnlySpanAction<T>(ReadOnlySpan<T> span);
/// <summary>
...
internal static class PooledDelegates
{
    ...
    public static Releaser GetPooledAction<TArg>(Action<TArg> unboundAction, TArg argument, out Action boundAction)
        => GetPooledDelegate<ActionWithBoundArgument<TArg>, TArg, Action<TArg>, Action>(unboundAction, argument,
            out boundAction);
    ...
    /// <paramref name="argument"/>.</param>
    /// <returns>A disposable <see cref="Releaser"/> which returns the object to the delegate pool.</returns>
    public static Releaser GetPooledAction<T1, TArg>(Action<T1, TArg> unboundAction, TArg argument,
        out Action<T1> boundAction)
        => GetPooledDelegate<ActionWithBoundArgument<T1, TArg>, TArg, Action<T1, TArg>, Action<T1>>(unboundAction,
            argument, out boundAction);
    ...
    /// <paramref name="argument"/>.</param>
    /// <returns>A disposable <see cref="Releaser"/> which returns the object to the delegate pool.</returns>
    public static Releaser GetPooledAction<T1, T2, TArg>(Action<T1, T2, TArg> unboundAction, TArg argument,
        out Action<T1, T2> boundAction)
        => GetPooledDelegate<ActionWithBoundArgument<T1, T2, TArg>, TArg, Action<T1, T2, TArg>, Action<T1, T2>>(
    ...
    /// <paramref name="argument"/>.</param>
    /// <returns>A disposable <see cref="Releaser"/> which returns the object to the delegate pool.</returns>
    public static Releaser GetPooledAction<T1, T2, T3, TArg>(Action<T1, T2, T3, TArg> unboundAction, TArg argument,
        out Action<T1, T2, T3> boundAction)
        => GetPooledDelegate<ActionWithBoundArgument<T1, T2, T3, TArg>, TArg, Action<T1, T2, T3, TArg>,
            Action<T1, T2, T3>>(unboundAction, argument, out boundAction);
    ...
    /// <paramref name="argument"/>.</param>
    /// <returns>A disposable <see cref="Releaser"/> which returns the object to the delegate pool.</returns>
    public static Releaser GetPooledFunction<TArg, TResult>(Func<TArg, TResult> unboundFunction, TArg argument,
        out Func<TResult> boundFunction)
        => GetPooledDelegate<FuncWithBoundArgument<TArg, TResult>, TArg, Func<TArg, TResult>, Func<TResult>>(
    ...
    /// <paramref name="argument"/>.</param>
    /// <returns>A disposable <see cref="Releaser"/> which returns the object to the delegate pool.</returns>
    public static Releaser GetPooledFunction<T1, TArg, TResult>(Func<T1, TArg, TResult> unboundFunction,
        TArg argument, out Func<T1, TResult> boundFunction)
        => GetPooledDelegate<FuncWithBoundArgument<T1, TArg, TResult>, TArg, Func<T1, TArg, TResult>,
            Func<T1, TResult>>(unboundFunction, argument, out boundFunction);
    ...
    /// <paramref name="argument"/>.</param>
    /// <returns>A disposable <see cref="Releaser"/> which returns the object to the delegate pool.</returns>
    public static Releaser GetPooledFunction<T1, T2, TArg, TResult>(Func<T1, T2, TArg, TResult> unboundFunction,
        TArg argument, out Func<T1, T2, TResult> boundFunction)
        => GetPooledDelegate<FuncWithBoundArgument<T1, T2, TArg, TResult>, TArg, Func<T1, T2, TArg, TResult>,
            Func<T1, T2, TResult>>(unboundFunction, argument, out boundFunction);
    ...
    public static Releaser GetPooledFunction<T1, T2, T3, TArg, TResult>(
        Func<T1, T2, T3, TArg, TResult> unboundFunction, TArg argument, out Func<T1, T2, T3, TResult> boundFunction)
        => GetPooledDelegate<FuncWithBoundArgument<T1, T2, T3, TArg, TResult>, TArg, Func<T1, T2, T3, TArg, TResult>
            , Func<T1, T2, T3, TResult>>(unboundFunction, argument, out boundFunction);

    /// <summary>
    /// Gets an <see cref="StatelessSpanAction{T}"/> delegate, which calls <paramref name="unboundSpanAction"/> with the specified
    /// <paramref name="argument"/>. The resulting <paramref name="boundSpanAction"/> may be called any number of times
    /// until the returned <see cref="Releaser"/> is disposed.
    /// </summary>
    /// <example>
    /// <para>The following example shows the use of a capturing delegate for a callback action that requires an
    ...
    /// <code>
    /// int x = 3;
    /// using var _ = GetPooledReadOnlySpanAction((span, arg) => arg.self.DoSomething(span, arg.x), (self: this, x), out StatelessReadOnlySpanAction&lt;int&gt; action);
    /// RunWithActionCallback(action);
    /// </code>
    /// </example>
    /// <typeparam name="T">The type of span element.</typeparam>
    /// <typeparam name="TArg">The type of argument to pass to <paramref name="unboundSpanAction"/>.</typeparam>
    /// <param name="unboundSpanAction">The unbound action delegate.</param>
    /// <param name="argument">The argument to pass to the unbound action delegate.</param>
    /// <param name="boundSpanAction">A delegate which calls <paramref name="unboundSpanAction"/> with the specified
    /// <paramref name="argument"/>.</param>
    /// <returns>A disposable <see cref="Releaser"/> which returns the object to the delegate pool.</returns>
    public static Releaser GetPooledSpanAction<T, TArg>(SpanAction<T, TArg> unboundSpanAction, TArg argument,
        out StatelessSpanAction<T> boundSpanAction)
        => GetPooledDelegate<SpanActionWithBoundState<T, TArg>, TArg, SpanAction<T, TArg>,
            StatelessSpanAction<T>>(unboundSpanAction, argument, out boundSpanAction);

    /// <summary>
    /// Gets an <see cref="StatelessReadOnlySpanAction{T}"/> delegate, which calls <paramref name="unboundSpanAction"/> with the specified
    /// <paramref name="argument"/>. The resulting <paramref name="boundSpanAction"/> may be called any number of times
    /// until the returned <see cref="Releaser"/> is disposed.
    /// </summary>
    /// <example>
    ...
    /// <paramref name="argument"/>.</param>
    /// <returns>A disposable <see cref="Releaser"/> which returns the object to the delegate pool.</returns>
    public static Releaser GetPooledReadOnlySpanAction<T, TArg>(ReadOnlySpanAction<T, TArg> unboundSpanAction, TArg argument,
        out StatelessReadOnlySpanAction<T> boundSpanAction)
        => GetPooledDelegate<ReadOnlySpanActionWithBoundState<T, TArg>, TArg, ReadOnlySpanAction<T, TArg>,
            StatelessReadOnlySpanAction<T>>(unboundSpanAction, argument, out boundSpanAction);
    ...
    private abstract class
        AbstractDelegateWithBoundArgument<TSelf, TArg, TUnboundDelegate, TBoundDelegate> : Poolable
        ...
        where TBoundDelegate : Delegate
    {
        ...
        protected TUnboundDelegate UnboundDelegate { get; private set; }
    ...
    private sealed class ActionWithBoundArgument<T1, T2, TArg>
        : AbstractDelegateWithBoundArgument<ActionWithBoundArgument<T1, T2, TArg>, TArg, Action<T1, T2, TArg>,
            Action<T1, T2>>
    {
    ...
    private sealed class ActionWithBoundArgument<T1, T2, T3, TArg>
        : AbstractDelegateWithBoundArgument<ActionWithBoundArgument<T1, T2, T3, TArg>, TArg,
            Action<T1, T2, T3, TArg>, Action<T1, T2, T3>>
    {
    ...
    private sealed class FuncWithBoundArgument<TArg, TResult>
        : AbstractDelegateWithBoundArgument<FuncWithBoundArgument<TArg, TResult>, TArg, Func<TArg, TResult>,
            Func<TResult>>
    {
    ...
    private sealed class FuncWithBoundArgument<T1, TArg, TResult>
        : AbstractDelegateWithBoundArgument<FuncWithBoundArgument<T1, TArg, TResult>, TArg, Func<T1, TArg, TResult>,
            Func<T1, TResult>>
    {
    ...
    private sealed class FuncWithBoundArgument<T1, T2, TArg, TResult>
        : AbstractDelegateWithBoundArgument<FuncWithBoundArgument<T1, T2, TArg, TResult>, TArg,
            Func<T1, T2, TArg, TResult>, Func<T1, T2, TResult>>
    {
    ...
    private sealed class FuncWithBoundArgument<T1, T2, T3, TArg, TResult>
        : AbstractDelegateWithBoundArgument<FuncWithBoundArgument<T1, T2, T3, TArg, TResult>, TArg,
            Func<T1, T2, T3, TArg, TResult>, Func<T1, T2, T3, TResult>>
    {
        protected override Func<T1, T2, T3, TResult> Bind()
            => (arg1, arg2, arg3) => UnboundDelegate(arg1, arg2, arg3, Argument);
    }

    private sealed class SpanActionWithBoundState<T, TArg>
        : AbstractDelegateWithBoundArgument<SpanActionWithBoundState<T, TArg>, TArg, SpanAction<T, TArg>,
            StatelessSpanAction<T>>
    {
        protected override StatelessSpanAction<T> Bind() => (span) => UnboundDelegate(span, Argument);
    }

    private sealed class ReadOnlySpanActionWithBoundState<T, TArg>
        : AbstractDelegateWithBoundArgument<ReadOnlySpanActionWithBoundState<T, TArg>, TArg,
            ReadOnlySpanAction<T, TArg>, StatelessReadOnlySpanAction<T>>
    {
        protected override StatelessReadOnlySpanAction<T> Bind() => (span) => UnboundDelegate(span, Argument);
    }
